...
응답 분포의 매개변수는 현재 상태에 의해 결정됩니다. 데이터가 실수 선에 지지대를 갖는 경우 간단한 모델은 다음과 같습니다.
