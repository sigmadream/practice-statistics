...
YPA 값이 가장 높은 선수들은 주로 큰 야드(big yardage)를 획득하기 위해 한두 번의 패스(일반적으로 트릭 플레이)를 던져 성공시킨 선수들이기 때문에 이는 아직 큰 정보를 주지 못합니다. 이 문제를 해결하려면 한 시즌 내 일정 패스 시도 횟수(100번)를 기준으로 필터링하고 결과를 확인해 보세요.
