...
수준이 많은 범주형 변수를 낮은 차원의 벡터 세트로 변환하기 위해 전체 _엔티티 임베딩(entity embeddings)_ 세트를 구축(build)할 수 있습니다(Guo and Berkhahn 2016). 이 접근 방식은 Ames의 이웃과 함께 사용한 예제보다 훨씬 더 많은 카테고리 수준을 가진 명목형(nominal) 변수에 가장 적합(best suited)합니다.
