...
이 책의 첫 번째 부분을 읽고 나면, 여러분은 데이터 과학을 수행하기 위한 중요한 도구들을 (적어도 표면적으로는) 이해하게 됩니다. 이제 세부 사항으로 깊이 들어갈 시간입니다. 이 책의 이번 부분에서는 <a href="#fig-ds-visualize" data-type="xref">그림 II-1</a>에서 더 깊이 있게 데이터를 시각화하는 방법에 대해 배울 것입니다.
