...
- 다른 사람이 작성한 코드를 더 많이 읽다 보면 tidyverse를 사용하지 않는 코드를 더 많이 보게 될 것입니다. <a href="ch27.html#chp-base-R" data-type="xref">27장</a>에서는 실제 환경에서 보게 될 중요한 기본(base) R 함수 중 일부를 배울 것입니다.
