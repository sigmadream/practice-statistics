...
), Age = yearID - birthyear, SLG = (H - X2B - X3B - HR + 2 * X2B + 3 * X3B + 4 * HR) / AB, OBP = (H + BB + HBP) / (AB + BB + HBP + SF), OPS = SLG + OBP
...
mutate( AVG = H / AB, SLG = (H - X2B - X3B - HR + 2 * X2B + 3 * X3B + 4 * HR) / AB
...
SLG = (H - X2B - X3B - HR + 2 * X2B + 3 * X3B + 4 * HR) / AB, OBP = (H + BB + HBP) / (AB + BB + HBP + SF), OPS = SLG + OBP
