...
_경고. 이 장은 아마도 이 책에서 어려운 장일 수 있습니다. 하지만 이 중요한 주제를 끈기 있게 읽어나가신다면 통계적 추론(statistical inference)에 대한 귀중한 통찰을 얻으실 수 있을 것입니다._
...
단순한 경우는 표본 크기가 1일 때이며, 관측된 비율은 오른손잡이 또는 왼손잡이를 선택하는지에 따라 0 또는 1이어야 합니다. 이러한 이벤트는 각각 0.8 및 0.2의 확률로 발생합니다. 결과 확률 분포는 [그림 9.1](./19-CHAPTER_9__Putting_Probability_and_Statistics_Together.md#fig9-1)(a)에 나와 있습니다.
...
> 오차 빈도의 법칙으로 표현된 우주적 질서의 경이로운 형태만큼 내 상상력을 깊게 자극하는 것은 거의 없습니다. 그리스인들이 그것을 알았다면 그것을 의인화하고 신격화했을 것입니다. 그것은 격렬한 혼란 속에서 고요함과 완전한 자기 소멸 상태로 군림합니다. 대중이 거대할수록, 겉으로 보이는 아노미 상태가 클수록 그 지배력은 더욱 완벽해집니다. 그것은 비이성의 최고 법칙(supreme law of Unreason)입니다. 통제되지 않은 수많은 혼란스러운 요소들을 무작위로 추출하여 크기 순으로 배열할 때마다 숨어 있던 아름답고 질서 정연한 형태가 드러납니다.
